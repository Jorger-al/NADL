...
export default function ExploreByRegion() {
  ...
  useEffect(() => {
    async function fetchSites() {
      try {
        const response = await fetch("/directus-api/items/sites?limit=-1");
        ...
        const filtered = (result.data || []).filter((site) => {
          ...
          return insideRegion && matchesType;
        }).sort((a, b) =>
