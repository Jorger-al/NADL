        ...
        <section className="relative w-full h-[55vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-4 w-full max-w-[1200px] mx-auto flex flex-col items-center">
            ...
            <p className="text-gray-200 text-lg md:text-xl font-light max-w-2xl mb-10">
              Exploring carvings, symbolic representations, engravings, and artwork recovered from historical vessels and maritime locations.
            </p>
            <Link to="/explore/iconography">
            ...
            <div className="w-full md:w-1/2">
              <div className="aspect-square overflow-hidden border border-gray-200 bg-white p-2">
                <img
                  ...
                  alt="Carved ship ornaments"
                  className="w-full h-full object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-700"
                />
              </div>
            </div>
            <div className="w-full md:w-1/2 flex flex-col justify-center">
              <h2 className="text-3xl md:text-4xl font-light text-[#1e3a5f] mb-8 font-display tracking-wide">Artistic Symbols</h2>
              <p className="text-[#4b5563] text-lg leading-relaxed mb-8 font-light">
                Ships were often decorated with complex figureheads, carvings, and painted symbols. This iconography reveals the religious, cultural, and political contexts of the builders and crew.
              </p>
            </div>
          </div>
            ...
            <div className="w-full md:w-1/2">
              <div className="aspect-square overflow-hidden border border-gray-200 bg-white p-2">
                <img
                  ...
                  alt="Decorated artifacts"
                  className="w-full h-full object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-700"
                />
              </div>
            </div>
            <div className="w-full md:w-1/2 flex flex-col justify-center">
              <h2 className="text-3xl md:text-4xl font-light text-[#1e3a5f] mb-8 font-display tracking-wide">Documenting Motifs</h2>
              <p className="text-[#4b5563] text-lg leading-relaxed mb-8 font-light">
                By documenting recurring motifs and inscriptions, archaeologists can trace cultural exchange across maritime trade networks and identify the workshops where ship fittings were crafted.
              </p>
            </div>
          </div>
          ...
          <div className="w-full max-w-[1400px] mx-auto px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
              {[
                ...
                <Link
                  key={region.title}
                  to={`/explore/iconography/${region.slug}`}
