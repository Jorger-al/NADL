...
export default function ShipyardStructure() {
  return (
        ...
        <section className="relative w-full h-[55vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-4 w-full max-w-[1200px] mx-auto flex flex-col items-center">
            ...
            <p className="text-gray-200 text-lg md:text-xl font-light max-w-2xl mb-10">
              Exploring historic shipyards, slipways, dry docks, building berths, and facilities where vessels were designed and launched.
            </p>
            <Link to="/explore/shipyard-structures">
            ...
            <div className="w-full md:w-1/2">
              <div className="aspect-square overflow-hidden border border-gray-200 bg-white p-2">
                <img
                  ...
                  alt="Historic slipway ruins"
                  className="w-full h-full object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-700"
                />
              </div>
            </div>
            <div className="w-full md:w-1/2 flex flex-col justify-center">
              <h2 className="text-3xl md:text-4xl font-light text-[#1e3a5f] mb-8 font-display tracking-wide">Birthplaces of Fleets</h2>
              <p className="text-[#4b5563] text-lg leading-relaxed mb-8 font-light">
                Historic shipyards reveal the industrial scale of past naval powers. Examining building berths, saw pits, and timber storage sheds helps us reconstruct the organization of early modern industries.
              </p>
            </div>
          </div>
            ...
            <div className="w-full md:w-1/2">
              <div className="aspect-square overflow-hidden border border-gray-200 bg-white p-2">
                <img
                  ...
                  alt="Excavated shipyard remains"
                  className="w-full h-full object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-700"
                />
              </div>
            </div>
            <div className="w-full md:w-1/2 flex flex-col justify-center">
              <h2 className="text-3xl md:text-4xl font-light text-[#1e3a5f] mb-8 font-display tracking-wide">Archaeological Remains</h2>
              <p className="text-[#4b5563] text-lg leading-relaxed mb-8 font-light">
                Many shipyard structures are now submerged or integrated into modern waterfronts. Through targeted excavation and mapping, we trace the spatial footprints of these ancient shipbuilder yards.
              </p>
            </div>
          </div>
          ...
          <div className="w-full max-w-[1400px] mx-auto px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
              {[
                ...
                <Link
                  key={region.title}
                  to={`/explore/shipyard/${region.slug}`}
