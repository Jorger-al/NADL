      ...
      <main className="flex-1 pt-16">
        ...
        <section className="relative w-full h-[55vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-4 w-full max-w-[1200px] mx-auto flex flex-col items-center">
            ...
            <p className="text-gray-200 text-lg md:text-xl font-light max-w-2xl mb-10">
              Exploring historical coastal fortifications, defensive strongholds, and maritime forts that guarded vital sea lanes.
            </p>
        ...
        <section className="w-full max-w-[1200px] mx-auto px-6 py-24 space-y-32">
            ...
            <div className="w-full md:w-1/2">
              <div className="aspect-square overflow-hidden border border-gray-200 bg-white p-2">
                <img
                  ...
                  alt="Historic fort structure"
                  className="w-full h-full object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-700"
                />
              </div>
            </div>
            <div className="w-full md:w-1/2 flex flex-col justify-center">
              <h2 className="text-3xl md:text-4xl font-light text-[#1e3a5f] mb-8 font-display tracking-wide">Coastal Defense Systems</h2>
              <p className="text-[#4b5563] text-lg leading-relaxed mb-8 font-light">
                Positioned strategically along trade routes, these forts protected empires' interests against pirate raids and opposing navies, showcasing advanced stone masonry and design.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-12 lg:gap-24">
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center">
              <h2 className="text-3xl md:text-4xl font-light text-[#1e3a5f] mb-8 font-display tracking-wide">Strategic Architecture</h2>
              <p className="text-[#4b5563] text-lg leading-relaxed mb-8 font-light">
                Our archaeological projects focus on surveying and mapping the remaining fort walls, batteries, and powder houses to reconstruct life on the maritime frontier.
              </p>
            </div>
          </div>
