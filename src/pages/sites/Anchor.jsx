        ...
        <section className="relative w-full h-[55vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-4 w-full max-w-[1200px] mx-auto flex flex-col items-center">
            ...
            <p className="text-gray-200 text-lg md:text-xl font-light max-w-2xl mb-10">
              Exploring the history of maritime anchors and mooring systems, tracing their development and role in seafaring throughout the centuries.
            </p>
            <Link to="/explore/anchors">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-24">
            <div className="w-full md:w-1/2">
              <div className="aspect-square overflow-hidden border border-gray-200 bg-white p-2">
                <img
                  src={Anchor1}
                  alt="Ancient iron anchor"
                  className="w-full h-full object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-700"
                />
              </div>
            </div>
            <div className="w-full md:w-1/2 flex flex-col justify-center">
              <h2 className="text-3xl md:text-4xl font-light text-[#1e3a5f] mb-8 font-display tracking-wide">Evolution of Design</h2>
              <p className="text-[#4b5563] text-lg leading-relaxed mb-8 font-light">
                From simple stone weights to complex iron structures, the anchor's evolution represents the advancement of metallurgy and naval engineering, keeping vessels secure in the most challenging conditions.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-12 lg:gap-24">
            <div className="w-full md:w-1/2">
              <div className="aspect-square overflow-hidden border border-gray-200 bg-white p-2">
                <img
                  src={Anchor2}
                  alt="Anchor on ocean floor"
                  className="w-full h-full object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-700"
                />
              </div>
            </div>
            <div className="w-full md:w-1/2 flex flex-col justify-center">
              <h2 className="text-3xl md:text-4xl font-light text-[#1e3a5f] mb-8 font-display tracking-wide">Archaeological Context</h2>
              <p className="text-[#4b5563] text-lg leading-relaxed mb-8 font-light">
                Anchors are often the only visible markers of shipwreck sites or ancient anchorage grounds. Studying their location, shape, and composition helps archaeologists map ancient trade routes and harbor activities.
              </p>
            </div>
          </div>
          ...
          <div className="w-full max-w-[1400px] mx-auto px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
              {[
                ...
                <Link
                  key={region.title}
                  to={`/explore/anchors/${region.slug}`}
