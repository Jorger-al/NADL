...
export default function HarborStructure() {
  return (
        ...
        <section className="relative w-full h-[55vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-4 w-full max-w-[1200px] mx-auto flex flex-col items-center">
            ...
            <p className="text-gray-200 text-lg md:text-xl font-light max-w-2xl mb-10">
              Exploring historic port installations, stone piers, timber wharves, docks, and breakwaters of the maritime past.
            </p>
            <Link to="/explore/harbor-structures">
        ...
        <section className="w-full max-w-[1200px] mx-auto px-6 py-24 space-y-32">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-24">
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center">
              <h2 className="text-3xl md:text-4xl font-light text-[#1e3a5f] mb-8 font-display tracking-wide">Ports of Trade</h2>
              <p className="text-[#4b5563] text-lg leading-relaxed mb-8 font-light">
                Harbor structures served as the vital links connecting maritime networks to terrestrial transport systems. Their scale and construction style document the trade volumes of historic civilizations.
              </p>
            </div>
          </div>
            ...
            <div className="w-full md:w-1/2">
              <div className="aspect-square overflow-hidden border border-gray-200 bg-white p-2">
                <img
                  ...
                  alt="Submerged harbor ruins"
                  className="w-full h-full object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-700"
                />
              </div>
            </div>
            <div className="w-full md:w-1/2 flex flex-col justify-center">
              <h2 className="text-3xl md:text-4xl font-light text-[#1e3a5f] mb-8 font-display tracking-wide">Engineering Under Water</h2>
              <p className="text-[#4b5563] text-lg leading-relaxed mb-8 font-light">
                Building underwater structures required complex engineering. We study Roman maritime concrete, wood piles, and ballast stone fills to understand ancient building technology.
              </p>
            </div>
          </div>
